...
#define CLASS_STRUCTURE_AIR_VEHICLE       ["config_name", "name", "cost_logistics", "cost_munitions", "cost_fuel", "paint", "anim", "isUtility"]
...
#define CLASS_DEFAULT_AIR_VEHICLE         ["", "", -1, -1, -1, "true", true, false]
