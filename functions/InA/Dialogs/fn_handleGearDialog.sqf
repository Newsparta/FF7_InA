...
g_dialog_handler_gear_item_purchase = {
	...
	switch (_itemType) do
	{
		case "weapon":
		{
			[weaponCrate, [_itemClassname, g_dialog_gear_num_items]] remoteExec ["addWeaponCargoGlobal", 2];
		};
		case "launcher":
		{
			[launcherCrate, [_itemClassname, g_dialog_gear_num_items]] remoteExec ["addWeaponCargoGlobal", 2];
		};
		case "rocket":
		{
			[launcherCrate, [_itemClassname, g_dialog_gear_num_items]] remoteExec ["addItemCargoGlobal", 2];
		};
		case "backpack":
		{
		...
		case "magazine":
		{
			[ammoCrate, [_itemClassname, g_dialog_gear_num_items]] remoteExec ["addMagazineCargoGlobal", 2];
		};
		case "grenade":
		{
			[grenadeCrate, [_itemClassname, g_dialog_gear_num_items]] remoteExec ["addItemCargoGlobal", 2];
		};
		case "explosive":
		{
			[explosiveCrate, [_itemClassname, g_dialog_gear_num_items]] remoteExec ["addMagazineCargoGlobal", 2];
		};
		case "medical":
		{
			[medicalCrate, [_itemClassname, g_dialog_gear_num_items]] remoteExec ["addItemCargoGlobal", 2];
		};
		case "other":
		{
