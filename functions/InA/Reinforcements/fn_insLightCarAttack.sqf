/* ----------
Function: InA_fnc_insLightCarAttack
...
Example:
    ...
    [[0,0,0], 1500, 250, 1, 0] spawn InA_fnc_insLightCarAttack
...
sleep _delay;
	...
	for "_x" from 1 to _s do {
		...
		if (supplier == "BLU") then {
			_obj = (selectRandom INS_CAR_BLU) createVehicle _pos;
			[
				_obj,
			...
			_obj = (selectRandom INS_CAR_OPF) createVehicle _pos;
			[
				_obj,
